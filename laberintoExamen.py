...
def mover_jugador(laberinto, direccion, jugador_fila, jugador_columna):
    ...
    if direccion == "s" and jugador_fila > 0 and laberinto[jugador_fila - 1][jugador_columna] != pared:
        nueva_fila -= 1
    elif direccion == "a" and jugador_fila < filas - 1 and laberinto[jugador_fila + 1][jugador_columna] != pared:
        nueva_fila += 1
    elif direccion == "d" and jugador_columna > 0 and laberinto[jugador_fila][jugador_columna - 1] != pared:
        nueva_columna -= 1
    elif direccion == "w" and jugador_columna < columnas - 1 and laberinto[jugador_fila][jugador_columna + 1] != pared:
        nueva_columna += 1
